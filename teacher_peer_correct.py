...
def teacher_peer_correct(driver):
    try:
        print("測試：辦公室-同儕作業管理-作業批改")
        menu_expanded_with_sibling(driver, "同儕作業管理", "作業批改")
        time.sleep(2)
        if "同儕作業一" in driver.page_source and "改完" in driver.page_source:
